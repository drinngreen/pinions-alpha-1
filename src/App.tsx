  ...
  return (
    <div className="min-h-screen bg-gradient-main">
      ...
      <div className="max-w-7xl mx-auto pt-20 px-4 flex relative">
        <aside className={`fixed left-0 top-0 h-full bg-gradient-card transition-all duration-300 
        ...
        <main className={`${isTrendingExpanded ? 'ml-[300px]' : ''} flex-1 transition-all duration-300 mr-[220px]`}>
